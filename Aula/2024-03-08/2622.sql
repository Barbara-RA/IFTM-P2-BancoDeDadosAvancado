...
/*
O setor de vendas quer fazer uma promoção para todos os clientes pessoas jurídicas. 
Para isso você deve exibir o nome dos clientes que são pessoas jurídicas.*/
