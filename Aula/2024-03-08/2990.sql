...
/*
Mostrar CPF, nome dos funcionários (empregados) e nome do departamento (departamentos) dos 
funcionários que não trabalham (trabalha) em nenhum projeto (projetos). O resultado deverá ser ordenado por CPF.*/
